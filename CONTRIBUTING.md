...
You should fork the Quill repo using the "Fork" button at the top right of the Quill GitHub [site](https://github.com/nextlinux/quill/). You will be doing your development in your fork, then submit a pull request to Quill. There are many resources how to use GitHub effectively, we will not cover those here.

## Adding a feature or fix

If you look at the Quill [Issue](https://github.com/nextlinux/quill/issues) there are plenty of bugs and feature requests. Maybe look at the [good first issue](https://github.com/nextlinux/quill/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) list if you're not sure where to start.

## Commit guidelines

In the Quill project we like commits and pull requests (PR) to be easy to understand and review. Open source thrives best when everything happening is over documented and small enough to be understood.
...
If you made it this far and all the tests are passing, it's time to submit a Pull Request (PR) for Quill. Submitting a PR is always a scary moment as what happens next can be an unknown. The Quill project strives to be easy to work with, we appreciate all contributions. Nobody is going to yell at you or try to make you feel bad. We love contributions and know how scary that first PR can be.
...
And lastly, when proposed changes are modifying user-facing functionality or output, it is expected the PR will include updates to the documentation as well. Quill is not a project that is heavy on documentation. This will mostly be updating the README and help for the tool.
