...
bootstrap-tools: $(TEMP_DIR)
	#GOBIN="$(realpath $(TEMP_DIR))" go install github.com/nextlinux/quill/cmd/quill@$(QUILL_VERSION)
...
unit: $(TEMP_DIR)  ## Run unit tests (with coverage)
	...
	go test -coverprofile $(TEMP_DIR)/unit-coverage-details.txt $(shell go list ./... | grep -v nextlinux/quill/test)
